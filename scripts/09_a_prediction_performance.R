...
ggarrange(boxplot_rf_6mto6m, boxplot_rf_6mto12m, boxplot_rf_12mto6m, boxplot_rf_12mto12m,
    ...
    ggexport(filename = here("outputs", "figs", "summary_boxplots_data-cf_model-rf_desc_prediction.pdf"),
             width = 14, height = 9)
...
save_as_docx(
    ...
    path = here("outputs", "tables", "data-cf_model-rf_desc-all_perfromances_selfharm_events.docx")
)
