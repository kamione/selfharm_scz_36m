...
write_rds(results_mat_rf, file = here("cache", "data-imp_model-rf_desc-prediction_6mto6m.rds"))
# results_mat_rf <- read_rds(here("cache", "data-imp_model-rf_desc-prediction_6mto6m.rds"))
...
plot_timeseries_boxplots(
    results_mat_rf,
    saveplot = TRUE,
    filename = "boxplot_model-rf_data-imp_desc-prediction_results_6mto6m.pdf"
)
