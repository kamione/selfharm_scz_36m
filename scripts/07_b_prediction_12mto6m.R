...
# save cache
write_rds(results_mat_rf, here("cache", "data-imp_model-rf_desc-prediction_12mto6m.rds"))
# results_mat_rf <- read_rds(here("cache", "data-imp_model-rf_desc-prediction_12mto6m.rds"))
...
plot_timeseries_boxplots(
    results_mat_rf,
    saveplot = TRUE,
    filename = "boxplot_model-rf_data-imp_desc-prediction_results_12mto6m.pdf"
)
