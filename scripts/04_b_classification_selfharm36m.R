...
# save cache
write_rds(results_mat_rf_baseline, here("cache", "data-imp_model-rf_features-baseline_desc-prediction_baselineto36m.rds"))
# results_mat_rf_baseline <- read_rds(here("cache", "data-imp_model-rf_features-baseline_desc-prediction_baselineto36m.rds"))
...
# save cache
write_rds(results_mat_rf_baseline_mean, here("cache", "data-imp_model-rf_features-baseline_meansymptoms_desc-prediction_baselineto36m.rds"))
# results_mat_rf_baseline_mean <- read_rds(here("cache", "data-imp_model-rf_features-baseline_meansymptoms_desc-prediction_baselineto36m.rds"))
...
# save cache
write_rds(results_mat_rf_baseline_both, here("cache", "data-imp_model-rf_features-baseline_meanmssdsymptoms_desc-prediction_baselineto36m.rds"))
# results_mat_rf_baseline_both <- read_rds(here("cache", "data-imp_model-rf_features-baseline_meanmssdsymptoms_desc-prediction_baselineto36m.rds"))
...
ggsave(plot = figure_comparison_modelclassfication,
       file = here("outputs", "figs", "boxplot_model-rf_data-imp_desc-36m_classification_comparisons.pdf"),
       width = 5, 
       height = 4)
