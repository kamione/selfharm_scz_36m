...
longitudial_change_fig %>% 
    ggsave(filename = here("outputs", "figs", "data-imp_desc-longitudial_change.pdf"),
           height = 3,
           width = 6)
...
# save cache
write_rds(bw_object, here("cache", "data-imp_decs-bw_object.rds"))
...
# save cache
write_rds(fit_tvmvar, here("cache", "data-imp_decs-fit_tvmvar.rds"))
# fit_tvmvar <- read_rds(here("cache", "data-imp_decs-fit_tvmvar.rds"))
...
# Visualization ----------------------------------------------------------------
pdf(here("outputs", "figs", "data-imp_desc-tvmvar_lag1.pdf"), width = 12, height = 8)
